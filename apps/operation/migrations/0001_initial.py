# -*- coding: utf-8 -*-
# Generated by Django 1.9.8 on 2017-06-25 12:08
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone_num', models.CharField(max_length=11, verbose_name='\u624b\u673a')),
                ('course_ask', models.CharField(max_length=20, verbose_name='\u54a8\u8be2\u8bfe\u7a0b')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('add_time', models.DateTimeField(default=datetime.datetime.now, verbose_name='\u8ba2\u9605\u65f6\u95f4')),
                ('course', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='course.Course', verbose_name='\u8bfe\u7a0b')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name='\u7528\u6237')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('fav_id', models.IntegerField(default=0, verbose_name='\u5bf9\u8c61id')),
                ('fav_type', models.IntegerField(choices=[(1, '\u8bfe\u7a0b'), (2, '\u673a\u6784'), (3, '\u8bb2\u5e08')], default=1)),
